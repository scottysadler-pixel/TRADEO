...
| `standalone/index.html` / `trade.html` | Simple FX trading app (Chameleon + Catchup, calculator, journal). |
| `standalone/trial_dashboard.html` | Full analyst / trial dashboard (generated by `npm run trial`; no longer overwrites `index.html`). |
